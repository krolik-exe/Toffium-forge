...
public class MiskaBlock extends ToffiumforgeModElements.ModElement {
	@ObjectHolder("toffiumforge:miska")
	public static final Block block = null;
	public MiskaBlock(ToffiumforgeModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends SlabBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Miska z jedzeniem"));
		}

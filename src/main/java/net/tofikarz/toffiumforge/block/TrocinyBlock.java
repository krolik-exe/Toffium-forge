...
public class TrocinyBlock extends ToffiumforgeModElements.ModElement {
	@ObjectHolder("toffiumforge:trociny")
	public static final Block block = null;
	public TrocinyBlock(ToffiumforgeModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends SlabBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Idealny dla klatek swineczek i do zoo"));
		}

...
public class SwinkamorskaEntity extends ToffiumforgeModElements.ModElement {
	...
	@ObjectHolder("toffiumforge:entitybulletswinkamorska")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletswinkamorska").setRegistryName("entitybulletswinkamorska"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 2.5, (float) 10, (float) 5, false));
			this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 2.5));
			this.targetSelector.addGoal(3, new HurtByTargetGoal(this).setCallsForHelp(this.getClass()));
			this.goalSelector.addGoal(4, new FollowMobGoal(this, (float) 2.5, 20, 10));
			...
			this.goalSelector.addGoal(8, new PanicGoal(this, 3));
			this.goalSelector.addGoal(9, new RandomSwimmingGoal(this, 1, 40));
			this.goalSelector.addGoal(10, new BreedGoal(this, 3));
			this.goalSelector.addGoal(11, new EatGrassGoal(this));
			this.goalSelector.addGoal(12, new MeleeAttackGoal(this, 1.2, false));
			this.goalSelector.addGoal(13, new FollowParentGoal(this, 1));
			this.goalSelector.addGoal(14, new LookAtGoal(this, SwinkamorskaEntity.CustomEntity.class, (float) 6));

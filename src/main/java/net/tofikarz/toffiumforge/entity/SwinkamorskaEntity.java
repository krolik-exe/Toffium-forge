...
package net.tofikarz.toffiumforge.entity;
...
public class SwinkamorskaEntity extends ToffiumforgeModElements.ModElement {
	...
	public SwinkamorskaEntity(ToffiumforgeModElements instance) {
		super(instance, 2);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(124).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.4f, 0.7f))
						.build("swinkamorska").setRegistryName("swinkamorska");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -13261, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("swinkamorska_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 20, 4, 16));
	}
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new ChickenModel(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("toffiumforge:textures/guinea_pig_chicken.png");
				}
			});
		}
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Œwinka Morska"));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(7, new BreedGoal(this, 3));
			this.goalSelector.addGoal(8, new EatGrassGoal(this));
			this.goalSelector.addGoal(9, new FollowOwnerGoal(this, 2.5, (float) 10, (float) 2, false));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.bamboo.break"));
		}
